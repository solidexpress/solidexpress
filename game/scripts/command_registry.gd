...
extends RefCounted
## Single source of truth for keyboard / mouse shortcut documentation (F1 Help).
##
## Live input handlers (orbit_camera, viewport_interaction, main, sketch_mode,
## etc.) still bind keys locally. Migrate those handlers to match this table
## over time so Help, tests, and runtime cannot drift. Do not rewire every
## live keybinding until handlers can register against this registry safely.
...
const TABLE: Array[Dictionary] = [
	...
	{"keys": "Wheel / pinch", "context": "View", "desc": "Zoom toward cursor (Ctrl+wheel / Ctrl+two-finger harder; zoom-out gently recenters on the model)"},
	{"keys": "Shift+Wheel", "context": "View", "desc": "Pan vertically"},
	{"keys": "Alt+Wheel", "context": "View", "desc": "Orbit yaw (pans horizontally while sketch view is locked)"},
	{"keys": "Shift+Alt+Wheel", "context": "View", "desc": "Pan horizontally"},
	{"keys": "One-finger drag", "context": "View", "desc": "Orbit (touch → mouse emulation / empty-drag)"},
	{"keys": "Two-finger drag / pinch", "context": "View", "desc": "Pan + pinch-zoom (touch screen)"},
	{"keys": "Arrow keys", "context": "View", "desc": "Pan the view"},
	{"keys": "Shift+Arrows", "context": "View", "desc": "Orbit the view"},
	{"keys": "WASD", "context": "View", "desc": "Fly: W/S in/out along look, A/D strafe (sketch tools keep these keys while sketching)"},
	{"keys": "Alt+WASD", "context": "View", "desc": "Screen-space pan (arrows also pan)"},
	{"keys": "+ / - / PageUp / PageDown", "context": "View", "desc": "Zoom in / out at view center"},
	...
	{"keys": "F / Home", "context": "View", "desc": "Zoom extents — fit selection (or all if none), centered on the objects"},
	{"keys": "Shift+F / Shift+Home", "context": "View", "desc": "Zoom extents — fit all visible bodies"},
	...
	{"keys": "Shift+W", "context": "View", "desc": "Cycle display mode (shaded / edges / wireframe)"},
	...
	{"keys": "O", "context": "Model", "desc": "Apply hole at the selected face or body top (Depth 0 = through-all; Ø = nominal + hole_compensation)"},
	{"keys": "Shift+O", "context": "Model", "desc": "Arm Place hole… — click a point on a face"},
	{"keys": "Ctrl+Shift+O", "context": "Model", "desc": "Arm Hole Wizard… — click multiple points, then Enter / Apply holes"},
	{"keys": "Enter (Hole Wizard)", "context": "Model", "desc": "Commit accumulated multi-point holes as one Hole feature"},
	{"keys": "Esc (armed pick)", "context": "Model", "desc": "Cancel Hole Wizard or other armed precision pick"},
	{"keys": "Hole (selection strip)", "context": "Model", "desc": "Hole… size / depth / through-all dialog"},
...
## Full shortcut table for HelpOverlay and tests.
