...
const TABLE: Array[Dictionary] = [
	...
	{"keys": "O", "context": "Model", "desc": "Apply hole at the center of the selected face (Depth 0 = through)"},
	...
	{"keys": "Hole (selection strip)", "context": "Model", "desc": "Apply hole at face center (same as O)"},
