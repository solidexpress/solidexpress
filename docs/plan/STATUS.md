...
- [x] Mac-readable chrome + left stack (2026-08-15): body text is `UiScale.font(13)` (File menu size) instead of pinned 10–12 px; `LeftStack` docks palette / Modify-Name / sketch / mode rails / move Δ / card below measured TopChrome so File and Name never overlap; every body move shows a fresh ΔX/ΔY/ΔZ (layout + visual-ux suites)
